...
| ☀️ いちかくんの おてんき | [`otenki/`](otenki/) | はれ → くもり → あめ → かみなり → にじ |
| 🌙 いちかくんの よる の そら | [`yorunosora/`](yorunosora/) | ゆうやけ → おつきさま → ほし → ながれぼし → あさやけ |
...
- **チャイルドロック** 🔒: 右上の鍵ボタンで施錠。施錠中はナビ（戻る／進む／ホーム）が無効化＋自動で全画面化され、いちかくんが触ってもページ離脱しない。解除は鍵ボタンを **1.5秒長押し**
