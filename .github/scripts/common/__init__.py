...
- github_io.py       : PyGithub ラッパ（#14 実装済み）
- gh_cli.py          : ローカルデバッグ用 gh CLI ラッパ（#14 実装済み）
- repo_reader.py     : allowlist 制限付きファイル読み出し（#14 実装済み）
- score_parser.py    : claude-score / child-review-score マーカー抽出（#14 実装済み）
